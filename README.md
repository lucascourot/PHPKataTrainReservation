...
[![Build Status](https://travis-ci.org/lucascourot/PHPKataTrainReservation.svg?branch=master)](https://travis-ci.org/lucascourot/PHPKataTrainReservation)
[![Coverage Status](https://coveralls.io/repos/github/lucascourot/PHPKataTrainReservation/badge.svg?branch=master)](https://coveralls.io/github/lucascourot/PHPKataTrainReservation?branch=master)
...
You can get information about which each train has by using the train data service. You can assume the real service will behave the same way, but be available on a different url.

Again, you need [Python 3.3](http://python.org) and [CherryPy](http://www.cherrypy.org/), then start the server by running:

    make start_train_data
...
and attach form data for which seats to reserve. There should be three fields:
    ...
    "train_id", "seats" and "booking_reference"
